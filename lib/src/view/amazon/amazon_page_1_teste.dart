...
class AmazonPage01Teste extends StatefulWidget {
  const AmazonPage01Teste({super.key});

  @override
  State<AmazonPage01Teste> createState() => _AmazonPage01State();
}

class _AmazonPage01State extends State<AmazonPage01Teste> {
